...
% Include course-specific information from an external file.
% For an assignment catalog, make one course file for each course,
% and input the right course file for each assignment document.
% E.g.:
%\input{DD1341}
\input{courseinfo}
...
\newminted{java}{bgcolor=codebg,linenos=true,numberblanklines=false,numbersep=6pt,
  mathescape=true,texcl=true,gobble=2}
\newmintedfile{java}{linenos=true,numberblanklines=false,numbersep=6pt,
  stepnumber=5,mathescape=true,texcl=true}
\newmint{java}{bgcolor=codebg,mathescape=true,texcl=true}

% Header and footer
\pagestyle{fancy}
\lhead{\coursenr\ -\ Assignment \assignmentnr}
...
\def\assignmentnr{}
\def\thedate{\today}
\title{Assignment \assignmentnr\ - \coursenr\ \coursename}
\author{\theauthor}
\date{\thedate}
\begin{document}
